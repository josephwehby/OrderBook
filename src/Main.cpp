...
Main::Main() : wxFrame(nullptr, wxID_ANY, "Limit Order Book", wxPoint(30, 30), wxSize(380, 400)) {
	
    wxFont font(12, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false);

    mid_price = new wxStaticText(this, wxID_ANY, "0.00", wxPoint(140, 10), wxSize(50,30));
    spread = new wxStaticText(this, wxID_ANY, "0.00", wxPoint(140, 40), wxSize(50,30));
    mid_price->SetFont(font);
    spread->SetFont(font);
    
    bid = new wxStaticText(this, wxID_ANY, "Bid", wxPoint(70, 80), wxSize(50,30));
    bid->SetFont(font);
    bidbox = new wxListBox(this, 10004, wxPoint(10, 100), wxSize(150, 200));
    bidbox->SetForegroundColour(wxColour(*wxGREEN));
    
    ask = new wxStaticText(this, wxID_ANY, "Ask", wxPoint(230, 80), wxSize(50,30));
    ask->SetFont(font);
    askbox = new wxListBox(this, 10005, wxPoint(170, 100), wxSize(150, 200));
